...
\myparatight{Attack 2: Password Cracking After Shellshock Penetration}
...
\myparatight{Attack 3: Data Leakage After Shellshock Penetration}
...
\myparatight{Attack 5: VPNFilter}
