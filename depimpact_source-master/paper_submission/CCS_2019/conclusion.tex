\section{Conclusion}
We propose a novel approach, \tool, which computes discriminative weights for edges in a dependency graph built from system auditing events, and propagates reputation scores in the weighted graph to the POI. 
The discriminative edge weights enable \tool to reveal critical edges for reconstructing the attack sequence.
The POI reputation enables \tool to identify the root causes of POI and determine the trustworthiness/suspiciousness of POI.
