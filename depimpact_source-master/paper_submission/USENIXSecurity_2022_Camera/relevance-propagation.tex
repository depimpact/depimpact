...
% \rev{
% In \cref{subsec:phase3}, we explain how \tool propagates the dependency impact from the POI event, and ranks entry nodes. 
% From top-ranked entry nodes, \tool does the forward analysis to detect critical components which are related to the POI events and much smaller than the original dependency graph.
% }